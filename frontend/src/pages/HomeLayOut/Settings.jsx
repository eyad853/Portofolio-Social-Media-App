...
return (
    <div className="w-screen h-screen overflow-auto flex flex-col lg:flex-row">
        ...
        <div className={`w-full lg:w-1/5 pt-4 sm:pt-6 h-auto lg:h-screen border-b lg:border-r lg:border-b-0 ${
            darkMode 
                ? 'bg-gradient-to-br from-neutral-800 to-neutral-900 text-white border-neutral-700' 
                : 'bg-gradient-to-br from-neutral-700 to-neutral-800 border-neutral-700'
        } shadow-xl lg:shadow-2xl backdrop-blur-sm`}>
            <div className='flex text-2xl sm:text-3xl lg:text-4xl font-bold justify-center mb-6 sm:mb-8 bg-gradient-to-r from-neutral-800 to-neutral-900 bg-clip-text text-transparent'>
                Circle
            </div>
            ...
            <div className="flex lg:flex-col overflow-x-auto lg:overflow-x-visible gap-2 px-3 lg:px-0">
                ...
                <div className={`w-32 sm:w-40 lg:w-full h-14 lg:h-[10vh] flex-shrink-0 relative flex justify-center items-center font-semibold text-sm sm:text-base lg:text-xl transition-all duration-300 hover:scale-105 ${
                    ...
                    <span className="lg:hidden group-hover:text-neutral-800 transition-colors">🔔 Notif</span>
                    <span className="hidden lg:inline group-hover:text-neutral-800 transition-colors">🔔 Notifications</span>
                </div>
                <div className={`w-28 sm:w-36 lg:w-full h-14 lg:h-[10vh] flex-shrink-0 relative flex justify-center items-center font-semibold text-sm sm:text-base lg:text-xl transition-all duration-300 hover:scale-105 ${
                    darkMode ? 'hover:bg-neutral-700/50' : 'hover:bg-neutral-800'
                } cursor-pointer rounded-xl lg:rounded-r-none lg:rounded-l-xl group`}>
                    <Link to={`/home/friends`} className='absolute inset-0'/>
                    <span className="group-hover:text-neutral-900 transition-colors">👥 Friends</span>
                </div>
            </div>
        </div>
        ...
        <div className={`flex-1 overflow-auto ${
            darkMode 
                ? 'text-white bg-gradient-to-br from-neutral-900 to-neutral-800' 
                : 'bg-gradient-to-br from-neutral-700 to-neutral-800'
        }`}>
            {/* Message Box - Enhanced */}
            {isMessageVisible && (
                <div className="fixed top-16 sm:top-5 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-neutral-700 to-neutral-800 text-white px-4 sm:px-6 py-3 rounded-xl shadow-2xl z-50 text-sm sm:text-base font-medium backdrop-blur-sm border border-white/20 animate-pulse">
            ...
            <div className="w-full h-full flex overflow-auto">
                ...
                <div className={`overflow-auto py-6 sm:py-8 px-6 sm:px-8 lg:px-12 flex-1 ${
                    darkMode ? 'bg-neutral-900/50' : 'bg-neutral-800/50'
                } backdrop-blur-sm`}>
                    <div className='w-full h-full max-w-4xl mx-auto'>

                        {/* Header */}
                        <div className="mb-8 sm:mb-12">
                            <div className="font-bold text-3xl sm:text-4xl lg:text-5xl mb-2 bg-gradient-to-r from-neutral-800 to-neutral-900 bg-clip-text text-transparent">
                                Account Settings
                            </div>
                            <div className={`text-sm sm:text-base ${darkMode ? 'text-neutral-400' : 'text-neutral-600'}`}>
                        ...
                        <div className={`${
                            darkMode ? 'bg-neutral-800/50 border-neutral-700' : 'bg-neutral-800 border-neutral-700'
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-8">
                                ...
                                <div className="relative group">
                                    <div className={`w-28 h-28 sm:w-36 sm:h-36 cursor-pointer rounded-full relative border-4 ${
                                        darkMode ? 'border-neutral-600' : 'border-neutral-700'
                                        ...
                                        {user && user?.avatar ? (
                                            ...
                                            <div className={`w-full h-full flex justify-center items-center ${
                                                ...
                                                <FaUser size={window.innerWidth < 640 ? 80 : 110} className={darkMode ? 'text-neutral-400' : 'text-neutral-400'} />
                                            </div>
                                        )}
                                        {/* Overlay */}
                                    ...
                                    <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-neutral-800 rounded-full flex items-center justify-center shadow-lg">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className={`${
                                    darkMode ? 'bg-neutral-700/50 border-neutral-600' : 'bg-neutral-700 border-neutral-600'
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                        <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                                            ...
                                            <div className="text-neutral-800 font-medium text-lg">{user?.username}</div>
                                        </div>
                                        <div
                                            onClick={() => setIsNameModalOpen(true)}
                                            className={`w-10 h-10 sm:w-12 sm:h-12 flex justify-center cursor-pointer rounded-full transition-all duration-300 ${
                                                darkMode ? 'hover:bg-neutral-600 border-neutral-500' : 'hover:bg-neutral-900 border-neutral-700'
                                            } border-2 items-center group hover:scale-110`}>
                                            <MdEdit className='cursor-pointer text-lg group-hover:text-neutral-800 transition-colors' />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className={`${
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                        <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                                            ...
                                            <div className="text-neutral-800 font-medium text-sm sm:text-base break-all sm:break-normal">{user?.email}</div>
                                        </div>
                                        <div
                        ...
                        <div className={`${
                            darkMode ? 'bg-neutral-900/20 border-neutral-800' : 'bg-neutral-800 border-neutral-700'
                        } rounded-2xl border p-6 sm:p-8 mb-8 shadow-xl backdrop-blur-sm`}>
                            <div className="mb-6">
                                <div className="font-bold text-xl sm:text-2xl mb-2 text-neutral-600 flex items-center gap-2">
                                    ⚠️ Danger Zone
                                </div>
                                <div className={`text-sm sm:text-base ${darkMode ? 'text-neutral-400' : 'text-neutral-600'}`}>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <div
                                    ...
                                    className="flex-1 flex justify-center items-center cursor-pointer transform hover:scale-105 border-2 border-neutral-700 text-neutral-600 hover:bg-neutral-700 hover:text-white h-12 sm:h-14 rounded-xl font-semibold text-sm sm:text-base transition-all duration-300">
                                    🚪 Logout
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    ...
                                    <div
                                        ...
                                        className={`w-16 sm:w-20 h-8 sm:h-10 rounded-full relative cursor-pointer transition-all duration-500 shadow-inner ${
                                            darkMode 
                                                ? 'bg-gradient-to-r from-neutral-700 to-neutral-800 shadow-neutral-700/50' 
                                                : 'bg-gradient-to-r from-neutral-700 to-neutral-800 shadow-neutral-700/50'
                                        } hover:shadow-lg`}>
