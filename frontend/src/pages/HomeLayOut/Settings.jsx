...
return (
    <div className="w-screen h-screen overflow-auto flex flex-col lg:flex-row">
        {/* Sidebar - Enhanced */}
        <div className={`w-full lg:w-1/5 pt-2 sm:pt-4 h-auto lg:h-screen border-b lg:border-r lg:border-b-0 ${
            darkMode ? 'bg-neutral-700 text-white border-neutral-600' : 'bg-neutral-100 border-neutral-300'
        } shadow-lg lg:shadow-2xl`}>
            <div className='flex text-2xl sm:text-3xl lg:text-4xl font-bold justify-center mb-2 sm:mb-4'>
                Circle
            </div>
            ...
            <div className="flex lg:flex-col overflow-x-auto lg:overflow-x-visible gap-1 px-2 lg:px-0">
                <div className={`w-24 sm:w-32 lg:w-full h-12 lg:h-[10vh] flex-shrink-0 relative flex justify-center items-center font-semibold text-sm sm:text-lg lg:text-2xl transition-all duration-300 ${
                    darkMode ? 'hover:bg-gray-700' : 'hover:bg-neutral-200'
                } cursor-pointer rounded lg:rounded-none`}>
                ...
                <div className={`w-32 sm:w-36 lg:w-full h-12 lg:h-[10vh] flex-shrink-0 relative flex justify-center items-center font-semibold text-sm sm:text-lg lg:text-2xl transition-all duration-300 ${
                    darkMode ? 'hover:bg-gray-700' : 'hover:bg-neutral-200'
                } cursor-pointer rounded lg:rounded-none`}>
            ...
            <div className="w-full h-full flex overflow-auto">
                ...
                <div className={`overflow-auto py-3 sm:py-5 px-4 sm:px-6 lg:px-10 flex-1 ${darkMode ? 'bg-neutral-800' : 'bg-white'}`}>
                    <div className='w-full h-full'>
                        ...
                        } rounded-xl border p-4 sm:p-6 mb-6 shadow-lg hover:shadow-xl transition-all duration-300`}>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
                                {/* Profile Picture - Enhanced */}
                                <div className="relative group">
                                    <div className={`w-24 h-24 sm:w-32 sm:h-32 cursor-pointer rounded-full relative border border-neutral-300 overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105`}>
                                        <input
                                            type="file"
                                            name="avatar"
                                ...
                                <div className="flex flex-col sm:flex-row sm:ml-5 font-medium sm:items-center gap-1 sm:gap-0">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div
                                            ...
                                            className={`w-8 h-8 sm:w-10 sm:h-10 flex justify-center cursor-pointer rounded-full transition-all duration-300 ${
                                                darkMode ? 'hover:bg-neutral-900' : 'hover:bg-neutral-200'
                                            } items-center ml-1 hover:scale-110`}>
                        ...
                        <div className={`${
                            darkMode ? 'bg-neutral-700 border-neutral-600' : 'bg-white border-neutral-300'
                        } rounded-xl border p-4 sm:p-6 mb-6 shadow-lg hover:shadow-xl transition-all duration-300 mt-8 sm:mt-10 pb-6 sm:pb-10`}>
                        ...
                        <div className={` ${darkMode ? 'bg-slate-800/50 border-slate-700' : 'bg-white border-gray-200'
