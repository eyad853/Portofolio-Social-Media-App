                        ...
                        <div className={`${
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <div
                                    ...
                                    className="flex-1 flex justify-center items-center cursor-pointer transform hover:scale-105 border-2 border-red-500 text-red-600 hover:bg-red-500 hover:text-white h-12 sm:h-14 rounded-xl font-semibold text-sm sm:text-base transition-all duration-300">
                                    🚪 Logout
                                </div>
                            </div>
                        </div>
